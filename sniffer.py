    ...
    try:
        while True:
            ...
            # TCP 
                ...
                print(TAB_1 + 'Sequence: {}, Acknowledgment: {}'.format(sequence, acknowledgment))
                print(TAB_1 + 'Flags:')
...
# Unpack ethernet frame for Linux implementation
...
def udp_segment(data):
    if len(data) < 8:
        return 0,0,0, data # Return empty values if packet is too short to unpack
